					...
					<div className="flex flex-col gap-3">
						...
						<table className="w-full text-xs" aria-label="steadyGray API options">
							...
							<tbody className="text-muted">
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">targetDensity</td><td className="py-2 pr-6">&apos;auto&apos;</td><td className="py-2">Target density ratio (0–1). &apos;auto&apos; uses the average of all lines.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">densityMode</td><td className="py-2 pr-6">&apos;canvas&apos;</td><td className="py-2">&apos;canvas&apos; renders each line off-screen and counts ink pixels. &apos;glyph-path&apos; uses opentype.js to compute true glyph area via bezier paths — font-exact but requires opentype.js and a CORS-accessible font URL. Falls back silently to &apos;canvas&apos; if opentype.js is not installed or the font cannot be loaded.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">fontUrl</td><td className="py-2 pr-6">—</td><td className="py-2">URL of the font file for glyph-path measurement. Required when densityMode is &apos;glyph-path&apos;. Must be same-origin or CORS-enabled.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">method</td><td className="py-2 pr-6">&apos;letter-spacing&apos;</td><td className="py-2">CSS property to adjust per line: &apos;letter-spacing&apos;, &apos;word-spacing&apos;, &apos;font-weight&apos;, or &apos;font-width&apos;.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">maxAdjustment</td><td className="py-2 pr-6">0.05</td><td className="py-2">Max correction magnitude in em units (letter/word-spacing), weight units (font-weight), or wdth units (font-width).</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">tolerance</td><td className="py-2 pr-6">0.01</td><td className="py-2">Minimum density difference required before a correction is applied. Lines within this threshold of the target are left untouched.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">calibrationFactor</td><td className="py-2 pr-6">2.0</td><td className="py-2">Strength of the correction — correction magnitude per 1.0 density unit difference. Higher = more aggressive.</td></tr>
								...
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">mode</td><td className="py-2 pr-6">&apos;equalize&apos;</td><td className="py-2">&apos;equalize&apos; brings all lines toward the same optical density. &apos;readability&apos; weights complex lines (long words / high syllable count) toward a slightly higher spacing target.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">complexity</td><td className="py-2 pr-6">&apos;word-length&apos;</td><td className="py-2">Complexity metric used in readability mode: &apos;word-length&apos; (avg chars/word, no deps), &apos;syllable&apos; (requires npm install syllable), or &apos;pos&apos; (part-of-speech weighting, falls back to &apos;word-length&apos; if the pos tagger is unavailable).</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">strength</td><td className="py-2 pr-6">0.5</td><td className="py-2">How aggressively to weight complex lines in readability mode. Range 0–1. At 0: same as equalize mode.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">active</td><td className="py-2 pr-6">true</td><td className="py-2">Set false to skip the correction entirely and restore the element to its original HTML.</td></tr>
							</tbody>
						</table>
					</div>
				<div className="flex flex-col gap-3">
