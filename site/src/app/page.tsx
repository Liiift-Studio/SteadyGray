		...
		<main className="flex flex-col items-center px-6 py-20 gap-24">
			...
			<section className="w-full max-w-2xl lg:max-w-5xl flex flex-col gap-6">
				...
				<div className="flex items-center gap-4">
					<CopyInstall />
					<a href="https://github.com/Liiift-Studio/SteadyGray" target="_blank" rel="noopener noreferrer" className="text-sm opacity-50 hover:opacity-100 transition-opacity">GitHub ↗</a>
				</div>
...
<GrayValueText maxAdjustment={0.05} calibrationFactor={2}>
  Your paragraph text here...
			...
			<footer className="w-full max-w-2xl lg:max-w-5xl flex flex-col gap-6 pt-8 border-t border-white/10 text-xs">
				<ToolDirectory current="steadyGray" />
				<div className="flex justify-between opacity-50">
				<span>steadyGray v{version}</span>
